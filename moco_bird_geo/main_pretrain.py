...
from data_loader.dataloader import Bird_Satellite_Dataset, GaussianBlur
...
parser.add_argument('--bird_path', metavar='DIR',
                    help='path to bird dataset')
parser.add_argument('--satellite_path', metavar='DIR',
                    help='path to satellite dataset')
parser.add_argument('--bird_satellite_pair_csv', metavar='CSV',
                    help='path to bird satellite pair csv')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if temporal == False:
        # 'Baseline'
        train_dataset = Bird_Satellite_Dataset(args.bird_path, args.satellite_path, args.bird_satellite_pair_csv,
